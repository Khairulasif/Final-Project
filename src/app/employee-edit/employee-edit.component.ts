  ...
  ngOnInit(): void {
    ...
    this.services.find(this.id).subscribe((task: modelType) => {
      ...
      this.form2 = new FormGroup({
        ...
        dateOfBirth: new FormControl(this.postList.dateOfBirth),
        joiningDate: new FormControl(this.postList.joiningDate),
        basicSalary: new FormControl(this.postList.basicSalary),
      })
